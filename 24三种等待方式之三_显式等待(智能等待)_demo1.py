...
# driver.get(r'http://deyunce:828123@hospital.deyunce.com')
#
#
# # ========新知识区========
# loc_loginname = (By.CSS_SELECTOR, 'input#loginname123')
#
# loginname = WebDriverWait(driver, 60).until(EC.visibility_of_element_located(loc_loginname), '元素没找到，哈哈哈')
# loginname.send_keys('dycadmin')
